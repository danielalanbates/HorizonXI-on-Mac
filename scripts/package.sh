...
#   HorizonXI-on-Mac.app   the launcher (preflight, repair, account, play)
#
...
echo "built $DMG"
echo
echo "Unsigned and un-notarised: Gatekeeper will block it on another Mac until it is signed"
echo "with a Developer ID and notarised. See docs/FINDINGS.md for the notarisation setup."
