#!/usr/bin/env python3
"""Generate the FFXI on Mac app icon: an original crystal/diamond motif in the
app's own Vana'diel palette (indigo/violet backdrop, crystal cyan facets, gold
glow) -- not a reproduction of Square Enix's own crystal logo."""
import math
...
crystal_dim = (84, 140, 179)
crystal_mid = (140, 212, 242)
crystal_bright = (240, 250, 255)
...
facets = [
    ([top, shoulder_l, waist_l], (96, 158, 198)),
    ([top, shoulder_r, waist_r], crystal_mid),
    ([top, shoulder_l, shoulder_r], crystal_bright),
    ([shoulder_l, waist_l, bottom], (70, 122, 158)),
    ([shoulder_r, waist_r, bottom], (110, 178, 214)),
    ([shoulder_l, shoulder_r, bottom], (128, 196, 228)),
]
...
out.save("/private/tmp/claude-501/-Users-daniel/669a67dd-e3ea-4214-8b21-f33786644b17/scratchpad/icon_1024.png")
